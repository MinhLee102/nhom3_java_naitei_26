...
- **Data Table**: Timestamp, Action badge, Actor profile (Admin / User), Event description, Delete individual log trigger.
- **Modal**: Clear old logs (> 90 days) batch purge modal.
...
| **A06** | Global Categories List | `AdminLayout` | `design/a06_admin_category_list/code.html` |
| **A07** | Create / Edit Category | `AdminLayout` | `design/a07_create_edit_category/code.html` |
| **A08** | Budget Templates List | `AdminLayout` | `design/a08_budget_template_list/code.html` |
| **A09** | Create / Edit Budget Template | `AdminLayout` | `design/a09_create_edit_budget_template/code.html` |
| **A10** | System Expenses List | `AdminLayout` | `design/a10_system_expense_list/code.html` |
| **A11** | System Expense Detail / Edit | `AdminLayout` | `design/a11_system_expense_detail/code.html` |
| **A12** | System Incomes List | `AdminLayout` | `design/a12_system_income_list/code.html` |
